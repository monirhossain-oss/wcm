const en = {
  ...
  blog: {
    metaTitle: 'Blog Stories | World Culture Marketplace', metaDescription: 'Explore traditions, craftsmanship, and cultural creativity from around the world.', heading: 'Cultural Stories', intro: 'Explore traditions, craftsmanship, and cultural creativity from around the world through an editorial lens.', empty: 'No stories found.',
  ...
  creators: {
    metaTitle: 'Discover Global Creators | WCM',
    metaDescription: 'Explore talented creators from around the world showcased on World Culture Marketplace.',
  ...
  explore: {
    metaTitle: 'Explore World Culture', metaDescription: 'Discover unique global heritage.', filteredDescription: 'Explore the best cultural creations matching these filters.',
