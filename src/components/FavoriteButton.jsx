...
export default function FavoriteButton({ listingId, initialIsFavorited, API_BASE_URL }) {
  ...
  return (
    <button
      ...
      className="absolute top-3 right-3 z-20 p-2 bg-white/90 dark:bg-black/60 backdrop-blur-md rounded-full shadow-lg opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300"
    >
      {isFavorited ? (
