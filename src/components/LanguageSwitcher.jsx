...
export default function LanguageSwitcher() {
  ...
  return <div>
    ...
    <select aria-label={t('common.language')} value={locale} onChange={(event) => switchLocale(event.target.value)} className="rounded-md border bg-transparent px-2 py-1 text-sm">
