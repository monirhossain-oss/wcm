...
export default function HeroSection() {
  return (
    <section className="relative w-full flex flex-col md:flex-row items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative w-full md:w-1/2 h-64 md:h-[80vh] flex-shrink-0">
        <HeroSlider />
      </div>
      ...
      <div className="relative z-10 w-full md:w-1/2 mt-6 md:mt-0 md:pl-12 flex flex-col justify-center text-left">
        ...
        {/* Title */}
        <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-extrabold leading-snug md:leading-tight mb-4 md:mb-6
  text-gray-900 dark:text-white drop-shadow-sm dark:drop-shadow-lg">
        ...
        {/* Description */}
        <p className="text-base sm:text-lg md:text-xl mb-6 max-w-lg leading-relaxed
