...
export default function ProfilePage() {
  ...
  const InfoRow = ({ label, value, icon: Icon }) => (
    <div className="flex items-center justify-between py-4 border-b border-gray-300 dark:border-white/20 last:border-0 group transition-all">
    ...
    <div className="min-h-screen bg-[#fafafa] dark:bg-[#050505] pt-12 pb-20 px-4 md:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          >
            <div className="p-2 bg-white dark:bg-[#111] rounded-full border border-gray-300 dark:border-white/20 group-hover:border-orange-500 shadow-sm">
              <FiArrowLeft />
            </div>
            BACK
          </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-white dark:bg-[#111] rounded-[2.5rem] border border-gray-300 dark:border-white/20 shadow-sm overflow-hidden flex flex-col items-center group/card">
          ...
          <div className="lg:col-span-8">
            <div className="bg-white dark:bg-[#111] rounded-[2.5rem] border border-gray-300 dark:border-white/20 shadow-sm overflow-hidden min-h-125">
              <div className="px-10 py-8 border-b border-gray-300 dark:border-white/20 flex items-center justify-between bg-[#fcfcfc] dark:bg-[#151515]">
                <div>
              ...
              <div className="p-10">
                ...
                {!isEditing ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 animate-in fade-in duration-500">
                    ...
                    <div className="md:col-span-2 mt-6 p-6 bg-ui rounded-3xl border border-dashed border-gray-300 dark:border-white/20 ">
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          {...register('firstName')}
                          className="w-full rounded-2xl px-6 py-4 border border-white/50 dark:border-white/20 focus:border-orange-500 bg-white dark:bg-black text-black dark:text-white transition-all outline-none text-sm font-bold shadow-sm"
                        />
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        {...register('bio')}
                        rows={4}
                        className="w-full rounded-2xl px-6 py-4 border border-white/50 dark:border-white/20 focus:border-orange-500 bg-white dark:bg-black text-black dark:text-white transition-all outline-none text-sm font-bold resize-none shadow-sm"
                      />
                    </div>
