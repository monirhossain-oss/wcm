          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-gray-100 dark:border-white/5 pb-8">
            <div>
              <h1 className="text-2xl font-black uppercase tracking-tighter dark:text-white flex items-center gap-3">
                <FiShield className="text-orange-500" /> My profile
              </h1>
            </div>
            <button
              onClick={() => {
          ...
          <div className="lg:col-span-8">
            <div className="bg-white dark:bg-[#0c0c0c] border border-gray-100 dark:border-white/5 shadow-sm rounded-lg overflow-hidden">
              <div className="p-8 md:p-10">
                {message.text && (
                  <div
                    className={`mb-8 p-4 rounded-md text-[10px] font-black uppercase flex items-center gap-3 animate-in slide-in-from-top-2 ${message.type === 'success' ? 'bg-green-500 text-white' : 'bg-red-500 text-white'}`}
                  >
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        {...register('bio')}
                        rows={4}
                        className="w-full rounded-md px-4 py-3 border border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/5 text-[11px] font-bold focus:border-orange-500 outline-none resize-none transition-all focus:ring-1 focus:ring-orange-500"
                      />
                    </div>
