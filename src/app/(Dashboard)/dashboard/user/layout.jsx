...
// import { LayoutDashboard, ShieldAlert, ShieldIcon, Gavel } from "lucide-react";

export default function DistrictAdminLayout({ children }) {
          ...
          <div className="p-4 border-t border-slate-800">
            <div className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-xl border border-slate-700">
              ...
              <div className="flex-1 overflow-hidden">
                {/* <p className="font-semibold text-sm text-white truncate">District Admin</p> */}
                {/* <p className="text-xs text-slate-500 truncate">admin@nars.gov.bd</p> */}
              </div>
            </div>
          </div>
        </aside>
        ...
        {isSidebarOpen && (
          <>
            ...
            <aside className="lg:hidden fixed left-0 top-0 bottom-0 w-72 bg-slate-900 z-50 shadow-2xl transition-transform duration-300">
              <div className="p-6 border-b border-slate-800">
                 {/* <h1 className="text-2xl font-bold text-white">NARS</h1> */}
              </div>
